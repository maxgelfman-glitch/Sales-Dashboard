...
SPORT_IDS = {"NFL": 2, "NBA": 4, "MLB": 3, "NHL": 6, "WNBA": 8, "NCAAF": 1, "NCAAB": 5, "ATP": 38, "WTA": 39}
LEAGUE_BY_SPORT = {v: ("TENNIS" if k in {"ATP", "WTA"} else k) for k, v in SPORT_IDS.items()}
...
class TheRundownSource:
    ...
    def __init__(self, api_key: str,
                 leagues: tuple[str, ...] = ("NFL", "NBA", "MLB", "NHL", "WNBA", "NCAAF", "NCAAB", "ATP", "WTA"),
